---
title: "ADR-001: EF Core in the Application layer"
description: "Why IApplicationDbContext exposes DbSet properties directly to Application handlers, skipping a repository layer between the Application and EF Core."
---

The Application layer needs to read and write data. This record documents why the template exposes EF Core abstractions directly to command and query handlers rather than placing a repository layer between them.

<Note>
  **Status: Accepted** — 2024-02-29
</Note>
